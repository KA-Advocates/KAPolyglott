...
/***/ function(module, exports, __webpack_require__) {
	...
	var _pageHelper = __webpack_require__(5);
	...
	var _contentHelper = __webpack_require__(6);

	var _contentHelper2 = _interopRequireDefault(_contentHelper);

	var _speechHelper = __webpack_require__(9);

	var _speechHelper2 = _interopRequireDefault(_speechHelper);

	var _translateBtn = __webpack_require__(11);

	var _translateBtn2 = _interopRequireDefault(_translateBtn);

	var _videoIcons = __webpack_require__(14);

	var _videoIcons2 = _interopRequireDefault(_videoIcons);
	...
	var ka = function () {
	  function ka() {
	    ...
	    this.pageHelper = new _pageHelper2.default();
	    this.URLHelper = new _URLHelper2.default();
	    this.APIHelper = new _APIHelper2.default();
	    this.contentHelper = new _contentHelper2.default();
	    this.speechHelper = new _speechHelper2.default();

	    this.titleHintBtn = new _translateBtn2.default(this.pageHelper.titleElementPath());
	    this.videoDescriptionHintBtn = new _translateBtn2.default(this.pageHelper.videoDescriptionElementPath());

	    this.videoIcons = new _videoIcons2.default();
	    this.popup = new _popup2.default();
	  }

	  _createClass(ka, [{
	    key: 'isSupportedURL',
	    value: function isSupportedURL() {
	      return this.URLHelper.matchesPattren(_config2.default.supportedURLPattren);
	    }
	    ...
	    value: function init() {
	      ...
	      this.URLHelper.subscribeToChange(function () {
	        _this.onURLChange;
	      });
...
/***/ function(module, exports) {
	...
	var CONFIG = {
	  ...
	  supportedURLPattren: /^https\:\/\/.*?\.khanacademy\.org\/.*?\/v\/.*/,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var pageHelper = function () {
	  ...
	  _createClass(pageHelper, [{
	    key: 'findjQuery',
	    value: function findjQuery() {
	      var _this = this;

	      var checkjQuery = function checkjQuery(callback) {
	        if (typeof jQuery !== 'function') return setTimeout(check.bind(_this, callback), 100);
	        callback(jQuery);
	      };
	    ...
	    value: function getTitle() {
	      return _jQuery2.default.trim((0, _jQuery2.default)('.task-title>span').text());
	    }
	  }, {
	    key: 'bindSpeakIcons',
	    value: function bindSpeakIcons(callback) {
	      (0, _jQuery2.default)('.kaext_translations_item .speak').each(function () {
	        var $icon = (0, _jQuery2.default)(this);
	        $icon.click(function () {
	          var text = _jQuery2.default.trim($icon.parent('.kaext_translations_item').text());
	          var lang = _jQuery2.default.trim($icon.attr('data-lang'));
	          callback(text, lang);
	        });
	      });
	    }
	    ...
	    value: function addCSS() {
	      (0, _jQuery2.default)('#ka-css').remove();
	      (0, _jQuery2.default)('head').append('<style id="ka-css">' + this.contentHelper.css() + '</style>');
	    }
	  }, {
	    key: 'titleElementPath',
	    value: function titleElementPath() {
	      return '.task-title>span';
	    }
	  }, {
	    key: 'videoDescriptionElementPath',
	    value: function videoDescriptionElementPath() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.contentHelper = undefined;
	...
	var contentHelper = exports.contentHelper = function () {
	  function contentHelper() {
	    _classCallCheck(this, contentHelper);
	  }

	  _createClass(contentHelper, [{
	    key: 'traslationHTML',
	    value: function traslationHTML(data) {
	      var html = [];
	      html.push('<div class="kaext_translations">');
	      _jQuery2.default.each(data, function (k, i) {
	        html.push('<div class="kaext_translations_item">');
	        html.push('' + "<img valign='bottom' src='" + kango.io.getResourceUrl("assets/images/flags/" + i.lang + ".png") + "' />" + '');
	    ...
	    key: 'videoIconsHTML',
	    value: function videoIconsHTML(data) {
	      var html = [];
	      _jQuery2.default.each(data, function (key, item) {
	        html.push('<div class="vid_icon clickable vid_flag_' + item.lang + '" data-vid="' + item.youtube_id + '" data-lang="' + item.lang + '">' + '<img src="' + kango.io.getResourceUrl('assets/images/flags/' + item.lang + '.png') + '">' + '</div>');
	      });
	      return html.join("\n");
	    }
	  }, {
...
/***/ function(module, exports) {
	...
	var URLHelper = exports.URLHelper = function () {
	  ...
	  _createClass(URLHelper, [{
	    key: 'matchesPattren',
	    value: function matchesPattren(pattren) {
	      return Boolean(location.href.match(pattren));
	    }
	  }, {
	    key: 'subscribeToChange',
	    value: function subscribeToChange(cb) {
	    ...
	    key: 'startCheckingForChanges',
	    value: function startCheckingForChanges() {
	      ...
	      setInterval(function () {
	        ...
	        if (location.href !== this._resentLoction) {
	          this._resentLoction = location.href;
	          this._subscribersToChange.forEach(function (callBack) {
	            callBack(_this._resentLoction);
	          });
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var APIHelper = exports.APIHelper = function () {
	  function APIHelper() {
	  ...
	  _createClass(APIHelper, [{
	    key: 'getTranslation',
	    value: function getTranslation(title, success, failure) {
	      var details = {
	        method: 'GET',
	        url: _config2.default.translateAPIURL,
	      ...
	      kango.xhr.send(details, function (data) {
	        if (data.status == 200 && data.response != null) {
	          ...
	          success(dataParsed);
	        } else failure(data.response);
	      });
	    }
	  }, {
	    key: 'getVideoData',
	    value: function getVideoData(ID, success, failure) {

	      var details = {
	        method: 'GET',
	        url: _config2.default.videoAPIURL,
	        params: { 'id': ID }
	      };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _responsiveVoice = __webpack_require__(10);

	var _responsiveVoice2 = _interopRequireDefault(_responsiveVoice);
	...
	var speechHelper = function () {
	  function speechHelper() {
	    _classCallCheck(this, speechHelper);

	    this.responsiveVoice = new _responsiveVoice2.default();
	  ...
	  _createClass(speechHelper, [{
	    key: 'speak',
	    value: function speak(text, lang) {
...
/***/ function(module, exports) {
	...
	*/
	    ...
	    a.speak = function (b, c, e) {
	        ...
	        if (b.length > a.CHARACTER_LIMIT) {
	            for (var d = b; d.length > a.CHARACTER_LIMIT;) {
	                b = d.search(/[:!?.;]+/);
	                var g = "";
	                if (-1 == b || b >= a.CHARACTER_LIMIT) b = d.search(/[,]+/);-1 == b && -1 == d.search(" ") && (b = 99);
	        ...
	        d = {};
	        if (null != b.mappedProfile) d = b.mappedProfile;else if (d.systemvoice = a.getMatchedVoice(b), d.collectionvoice = {}, null == d.systemvoice) {
	        ...
	        for (b = 0; b < f.length; b++) {
	            a.fallbackMode ? (a.fallback_playbackrate = a.def_fallback_playbackrate, c = a.selectBest([d.collectionvoice.pitch, d.systemvoice.pitch, 1]), g = a.selectBest([a.iOS9 ? 1 : null, d.collectionvoice.rate, d.systemvoice.rate, 1]), h = a.selectBest([d.collectionvoice.volume, d.systemvoice.volume, 1]), null != e && (c *= null != e.pitch ? e.pitch : 1, g *= null != e.rate ? e.rate : 1, h *= null != e.volume ? e.volume : 1), c /= 2, g /= 2, h *= 2, c = Math.min(Math.max(c, 0), 1), g = Math.min(Math.max(g, 0), 1), h = Math.min(Math.max(h, 0), 1), c = a.fallbackServicePath + "?t=" + encodeURIComponent(f[b]) + "&tl=" + (d.collectionvoice.lang || d.systemvoice.lang || "en-US") + "&sv=" + (d.collectionvoice.service || d.systemvoice.service || "") + "&vn=" + (d.collectionvoice.voicename || d.systemvoice.voicename || "") + "&pitch=" + c.toString() + "&rate=" + g.toString() + "&vol=" + h.toString(), g = document.createElement("AUDIO"), g.src = c, g.playbackRate = a.fallback_playbackrate, g.preload = "auto", g.load(), a.fallback_parts.push(g)) : (c = new SpeechSynthesisUtterance(), c.voice = d.systemvoice, c.voiceURI = d.systemvoice.voiceURI, c.volume = a.selectBest([d.collectionvoice.volume, d.systemvoice.volume, 1]), c.rate = a.selectBest([a.iOS9 ? 1 : null, d.collectionvoice.rate, d.systemvoice.rate, 1]), c.pitch = a.selectBest([d.collectionvoice.pitch, d.systemvoice.pitch, 1]), c.text = f[b], c.lang = a.selectBest([d.collectionvoice.lang, d.systemvoice.lang]), c.rvIndex = b, c.rvTotal = f.length, 0 == b && (c.onstart = a.speech_onstart), a.msgparameters.onendcalled = !1, null != e ? (b < f.length - 1 && 1 < f.length ? (c.onend = a.onPartEnd, c.hasOwnProperty("addEventListener") && c.addEventListener("end", a.onPartEnd)) : (c.onend = a.speech_onend, c.hasOwnProperty("addEventListener") && c.addEventListener("end", a.speech_onend)), c.onerror = e.onerror || function (a) {
	                console.log("RV: Unknow Error");
	                console.log(a);
	            }, c.onpause = e.onpause, c.onresume = e.onresume, c.onmark = e.onmark, c.onboundary = e.onboundary || a.onboundary, c.pitch = null != e.pitch ? e.pitch : c.pitch, c.rate = a.iOS ? (null != e.rate ? e.rate * e.rate : 1) * c.rate : (null != e.rate ? e.rate : 1) * c.rate, c.volume = null != e.volume ? e.volume : c.volume) : (c.onend = a.speech_onend, c.onerror = function (a) {
	                console.log("RV: Unknow Error");
	                console.log(a);
	...
	exports.default = ResponsiveVoice;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var translateBtn = function () {
	  function translateBtn(elementPath) {
	    _classCallCheck(this, translateBtn);

	    this.state = 'HIDDEN';
	    this.elementPath = elementPath;
	    this.unique = 'ka-translate-' + (Math.random() * Math.pow(36, 4) << 0).toString(36) + (Math.random() * Math.pow(36, 4) << 0).toString(36);
	  ...
	  _createClass(translateBtn, [{
	    key: 'bindAppearance',
	    value: function bindAppearance() {
	      var _this = this;

	      (0, _jQuery2.default)(document).on("DOMNodeInserted", function (evt) {
	        if ((0, _jQuery2.default)(_this.elementPath).length && !(0, _jQuery2.default)('.' + _this.unique).length) {
	          (0, _jQuery2.default)(_this.elementPath).append(_this.template);
	          _this.bindClick();
	    ...
	    value: function bindClick() {
	      ...
	      (0, _jQuery2.default)('.' + this.unique).unbind('click').click(function () {
	        _this2.onBtnClicked();
	      });
	    }
	  }, {
	    ...
	    value: function getContent() {
	      return _jQuery2.default.trim((0, _jQuery2.default)(this.elementPath).text());
	    }
	  }, {
	    key: 'onBtnClicked',
	    value: function onBtnClicked() {
	      var _this3 = this;

	      var content = this.getContent();
	      this.popup.open('Please wait...');
	      this.APIHelper.getTranslation(content, function (data) {
	        _this3.popup.open(_this3.contentHelper.traslationHTML(data));
	        _this3.pageHelper.bindSpeakIcons(function (text, lang) {
	          _this3.speechHelper.speak(text, lang);
	        });
	      }, function (data) {
	        _this3.popup.open('Error,Try again');
	      });
	    }
	  }, {
	    key: 'updateState',
	    value: function updateState(state) {
	      if (state === 'HIDDEN') (0, _jQuery2.default)('.' + this.unique).hide();else (0, _jQuery2.default)('.' + this.unique).show();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var popup = function () {
	  ...
	  _createClass(popup, [{
	    key: 'injectPopup',
	    value: function injectPopup() {
	      (0, _jQuery2.default)('body').append(["<style>", "#kaext_popup{", "width: 70%;", "background: #9CC333;", "border-radius: 8px;", "}", ".kaext_popup_wrapper{", "padding:30px;", "}", "</style>", "<div id='kaext_popup'>", "<div class='kaext_popup_wrapper'>", "<div class='text-right'><button class='kaext_popup_close'>X</button></div>", "<div class='kaext_popup_content'></div>", "</div>", "</div>"].join("\n"));
	    }
	  }, {
	    key: 'open',
	    value: function open(content) {
	      if (!(0, _jQuery2.default)('#kaext_popup').length) this.injectPopup();
	      (0, _jQuery2.default)('.kaext_popup_content').html('').append(content);
	      (0, _jQuery2.default)('#kaext_popup').popup('show');
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _jQuery2.default.popup;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var videoIcons = function () {
	  function videoIcons(options) {
	    _classCallCheck(this, videoIcons);
	  ...
	  _createClass(videoIcons, [{
	    key: 'bindAppearance',
	    value: function bindAppearance() {
	      var _this = this;

	      (0, _jQuery2.default)(document).on("DOMNodeInserted", function (evt) {
	        if ((0, _jQuery2.default)('iframe.player').length && !(0, _jQuery2.default)('#ka-ext-vid-icon').length) {

	          (0, _jQuery2.default)('body').append('<div id="ka-ext-vid-icon"></div>');

	          _this.APIHelper.getVideoData(_this.pageHelper.getVideoID(), function (data) {
	            (0, _jQuery2.default)('#ka-ext-vid-icon').append(_this.contentHelper.videoIconsHTML(data));
	            _this.bindVideoIcons(data);
	          }, function () {});
	        }
	      });
	    }
	    ...
	    key: 'bindVideoIcons',
	    value: function bindVideoIcons() {
	      var self = this;
	      (0, _jQuery2.default)('#ka-ext-vid-icon .vid_icon').each(function () {
	        var $icon = (0, _jQuery2.default)(this);
	        $icon.click(function () {
	          var ytID = _jQuery2.default.trim($icon.attr('data-vid'));
	          (0, _jQuery2.default)('#ka-ext-vid-icon .vid_icon').removeClass('active');
	          $icon.addClass('active');

	          (0, _jQuery2.default)('iframe.player').attr('src', 'https://www.youtube.com/embed/' + ytID + '?enablejsapi=1&html5=1&wmode=transparent&modestbranding=1&rel=0&fs=1&showinfo=0&autoplay=1&origin=https://de.khanacademy.org');
	        });
	      });
	    }
	  }, {
	    key: 'updateState',
	    value: function updateState(state) {
	      if (state === 'HIDDEN') (0, _jQuery2.default)('#ka-ext-vid-icon').hide();else (0, _jQuery2.default)('#ka-ext-vid-icon').show();
